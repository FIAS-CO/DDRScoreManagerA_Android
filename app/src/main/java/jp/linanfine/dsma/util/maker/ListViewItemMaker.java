...
abstract public class ListViewItemMaker extends AsyncTask<UniquePattern, Void, ListViewItemArguments> {
	...
	protected void addToList()
	{
		...
		//Log.e("DSMa", "P:"+String.valueOf(sProcessingConvertViewList.size())+" W:"+String.valueOf(sWaitingConvertViewList.size()));
	}
	...
	protected void removeFromList()
	{
		...
		//Log.e("DSMr", "P:"+String.valueOf(sProcessingConvertViewList.size())+" W:"+String.valueOf(sWaitingConvertViewList.size()));
	}
			 ...
			 if(pat.rivalScores != null)
			 {
		    	
				 {
					 ...
					 if(pat.rivalScores.containsKey(pat.MusicId))
					 {
						 ...
						 //Log.e("DSM", String.valueOf(pat.MusicId)+":"+String.valueOf(scoredata.ESP.Score));
					 }
					 else
					 {
						 scoredata = new MusicScore();
