    ...
    public static String textFromCopyFormat(String format, UniquePattern targetPattern, MusicData targetMusicData, ScoreData targetScoreData)
    {
        ...
        for (int index = 0; index < sps.length; ++index)
        {
            ...
            if (index % 2 == 0) {
                ...
                case 't': ret.append(targetMusicData.Name); break;
                case 'p':

                	fms = sps[index].split(":", -1);
                    switch (targetPattern.Pattern) {
						case bSP: ret.append(fms.length > 1 ? fms[1] : "b"); break;
						case BSP:
						case BDP:
							ret.append(fms.length > 2 ? fms[2] : "B"); break;
						case DSP:
						case DDP:
							ret.append(fms.length > 3 ? fms[3] : "D"); break;
						case ESP:
						case EDP:
							ret.append(fms.length > 4 ? fms[4] : "E"); break;
						case CSP:
						case CDP:
							ret.append(fms.length > 5 ? fms[5] : "C"); break;
					}
                    break;
                case 'y':
                	fms = sps[index].split(":", -1);
                    ...
                    case bSP:
						...
						case ESP:
						case CSP:
							ret.append(fms.length > 1 ? fms[1] : "SP"); break;
						case BDP:
						case DDP:
						case EDP:
						case CDP:
							ret.append(fms.length > 2 ? fms[2] : "DP"); break;
					}
                    break;
                case 's':
                ...
                case 'l':
                    ...
                    switch (targetScoreData.Rank) {
						case AAA: ret.append(fms.length > 1 ? fms[1] : "AAA"); break;
						case AAp: ret.append(fms.length > 2 ? fms[2] : "AA+"); break;
						case AA: ret.append(fms.length > 3 ? fms[3] : "AA"); break;
						case AAm: ret.append(fms.length > 4 ? fms[4] : "AA-"); break;
						case Ap: ret.append(fms.length > 5 ? fms[5] : "A+"); break;
						case A: ret.append(fms.length > 6 ? fms[6] : "A"); break;
						case Am: ret.append(fms.length > 7 ? fms[7] : "A-"); break;
						case Bp: ret.append(fms.length > 8 ? fms[8] : "B+"); break;
						case B: ret.append(fms.length > 9 ? fms[9] : "B"); break;
						case Bm: ret.append(fms.length > 10 ? fms[10] : "B-"); break;
						case Cp: ret.append(fms.length > 11 ? fms[11] : "C+"); break;
						case C: ret.append(fms.length > 12 ? fms[12] : "C"); break;
						case Cm: ret.append(fms.length > 13 ? fms[13] : "C-"); break;
						case Dp: ret.append(fms.length > 14 ? fms[14] : "D+"); break;
						case D: ret.append(fms.length > 15 ? fms[15] : "D"); break;
						case E: ret.append(fms.length > 16 ? fms[16] : "E"); break;
						case Noplay: ret.append(fms.length > 17 ? fms[17] : "-"); break;
                    }
                    break;
                case 'f':
                	fms = sps[index].split(":", -1);
                    switch (targetScoreData.FullComboType) {
						case MerverousFullCombo: ret.append(fms.length > 1 ? fms[1] : "MFC"); break;
						case PerfectFullCombo: ret.append(fms.length > 2 ? fms[2] : "PFC"); break;
						case FullCombo: ret.append(fms.length > 3 ? fms[3] : "FC"); break;
						case GoodFullCombo: ret.append(fms.length > 4 ? fms[4] : "GFC"); break;
						case Life4: ret.append(fms.length > 5 ? fms[5] : "Life4"); break;
						case None: ret.append(fms.length > 6 ? fms[6] : "NoFC"); break;
                    }
                    break;
                default: break;
                }
