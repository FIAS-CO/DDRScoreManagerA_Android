	...
	private String mRivalName;
	 ...
	 private void initialize()
	 {
	        ...
	        if(mRivalId != null)
	        {
			 ...
			 editMaxCombo.setOnClickListener(new OnClickListener() {
					public void onClick(View view) {
					    //テキスト入力を受け付けるビューを作成します。
					    final EditText editView = (EditText)ScoreEdit.this.getLayoutInflater().inflate(R.layout.view_digit_edit_text, null).findViewById(R.id.editText);
			 ...
			 editPlayCount.setOnClickListener(new OnClickListener() {
					public void onClick(View view) {
					    //テキスト入力を受け付けるビューを作成します。
					    final EditText editView = (EditText)ScoreEdit.this.getLayoutInflater().inflate(R.layout.view_digit_edit_text, null).findViewById(R.id.editText);
			 ...
			 editClearCount.setOnClickListener(new OnClickListener() {
					public void onClick(View view) {
					    //テキスト入力を受け付けるビューを作成します。
					    final EditText editView = (EditText)ScoreEdit.this.getLayoutInflater().inflate(R.layout.view_digit_edit_text, null).findViewById(R.id.editText);
			 ...
			 ((Button)this.findViewById(R.id.clear)).setOnClickListener(new OnClickListener() {
					public void onClick(View view) {
						  mScore = 0;
						  mCombo = 0;
						  mPlay = 0;
