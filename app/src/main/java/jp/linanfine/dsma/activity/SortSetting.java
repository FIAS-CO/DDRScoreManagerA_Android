	 ...
	 View mHandledView;
		...
		public static int getMusicSortTypeNum(MusicSortType sorttype)
		{
			return 
					...
					//sorttype == MusicSortType.RivalPlayCount ? 15 :
					//sorttype == MusicSortType.RivalClearCount ? 16 :
		...
		public static MusicSortType getMusicSortType(int typenum)
		{
			return
					...
					//typenum == 15 ? MusicSortType.RivalPlayCount :
					//typenum == 16 ? MusicSortType.RivalClearCount :
