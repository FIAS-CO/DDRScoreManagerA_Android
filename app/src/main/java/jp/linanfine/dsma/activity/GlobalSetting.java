...
public class GlobalSetting extends Activity {
	...
	//private ArrayList<String> mPagerItems;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) 
    {
        if (requestCode == 1) 
        {
        	//mSpinnerSelection = data.getIntExtra("jp.linanfine.dsma.pagerid", data.getIntExtra("jp.linanfine.dsma.pagerid", 0));
        }
    ...
    private void showDialogFromGate()
    {
    	...
    	mFromGate.setArguments( new AlertDialog.Builder(GlobalSetting.this)
	        ...
	        .setCancelable(false)
	        .setNegativeButton(GlobalSetting.this.getResources().getString(R.string.strings_global____cancel), new DialogInterface.OnClickListener() {
    ...
    private void initialize()
    {
		...
		/*mPagerCount = FileReader.readPagerCount(this);
		
		if(mPagerCount == 1)
		{
			((Button)this.findViewById(R.id.filterPageDel)).setEnabled(false);
		}

		mPagerItems = new ArrayList<String>();
		for(int i = 0; i < mPagerCount; i++)
		{
			mPagerItems.add(FileReader.readPagerName(this, i));
		}*/
		...
		this.findViewById(R.id.showComment).setVisibility(View.GONE);
		 ...
		 editPfc.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
				    ...
				    new AlertDialog.Builder(GlobalSetting.this)
				        ...
				        //setViewにてビューを設定します。
				        .setView(editView)
				        .setPositiveButton(GlobalSetting.this.getResources().getString(R.string.strings_global____ok), new DialogInterface.OnClickListener() {
				            public void onClick(DialogInterface dialog, int whichButton) {
					            InputMethodManager inputMethodManager = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
		 ...
		 logoutGate.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
					...
					startActivity(intent);
					//Toast.makeText(GlobalSetting.this, GlobalSetting.this.getString(R.string.global_setting_logout_message), Toast.LENGTH_LONG).show();
				}
	        });
		...
		((CheckBox)GlobalSetting.this.findViewById(R.id.useAsyncDraw)).setOnCheckedChangeListener(new OnCheckedChangeListener(){
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
		...
		((CheckBox)GlobalSetting.this.findViewById(R.id.useOldStyleDraw)).setOnCheckedChangeListener(new OnCheckedChangeListener(){
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
		 ...
		 testSizeSetting.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
		 ...
		 ((Button)this.findViewById(R.id.updateMusicList)).setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
...
/*
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, mPagerItems);
			adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
			mFilterSpinner.setAdapter(adapter);
			*/
		 Button pagerSetting = (Button)this.findViewById(R.id.filterSetting);
		 pagerSetting.setVisibility(View.GONE);
		 pagerSetting.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
...
/*
		 Button pagerAdd = (Button)this.findViewById(R.id.filterPageAdd);
		 pagerAdd.setVisibility(View.GONE);
		 pagerAdd.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {

					mPagerItems.add("Tab"+String.valueOf(mPagerCount));
				    
					ArrayAdapter<String> adapter = new ArrayAdapter<String>(GlobalSetting.this, android.R.layout.simple_spinner_item, mPagerItems);
						adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
						mFilterSpinner.setAdapter(adapter);
						mFilterSpinner.setSelection(mPagerCount);
						++mPagerCount;

						if(mPagerCount > 1)
						{
							((Button)GlobalSetting.this.findViewById(R.id.filterPageDel)).setEnabled(true);
						}

						//SharedPreferences pref = getSharedPreferences("PagerSetting", MODE_WORLD_READABLE | MODE_WORLD_WRITEABLE);
						SharedPreferences pref = getSharedPreferences("PagerSetting", MODE_PRIVATE);
						Editor e = pref.edit();
						e.putInt("PagerCount", mPagerCount);
						e.commit();

				}
	        });

		 Button pagerDel = (Button)this.findViewById(R.id.filterPageDel);
		 pagerDel.setVisibility(View.GONE);
		 pagerDel.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
					
					mPagerItems.remove(mPagerCount-1);

					ArrayAdapter<String> adapter = new ArrayAdapter<String>(GlobalSetting.this, android.R.layout.simple_spinner_item, mPagerItems);
						adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
						mFilterSpinner.setAdapter(adapter);
						//mFilterSpinner.setSelection(pos);
						--mPagerCount;
						...
						//pref = getSharedPreferences("MusicFilter"+String.valueOf(mPagerCount), MODE_WORLD_READABLE | MODE_WORLD_WRITEABLE);
						pref = getSharedPreferences("MusicFilter"+String.valueOf(mPagerCount), MODE_PRIVATE);
						e = pref.edit();
						e.clear();
						e.commit();
...
*/
		 ...
		 //importBackup.setVisibility(View.GONE);
		 ...
		 //exportBackup.setVisibility(View.GONE);
		 exportBackup.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
    		        ...
    		        alertDialogBuilder.setPositiveButton(getResources().getString(R.string.strings_global____ok),
    		                new DialogInterface.OnClickListener() {
    		                    public void onClick(DialogInterface dialog, int which) {
    		                    	FileReader.backupScores(GlobalSetting.this);
    		                    }
    		                });
    		        // アラートダイアログの否定ボタンがクリックされた時に呼び出されるコールバックリスナーを登録します
    		        alertDialogBuilder.setNegativeButton(getResources().getString(R.string.strings_global____cancel),
		 ...
		 //importBackup.setVisibility(View.GONE);
		 importBackup.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
    		        ...
    		        alertDialogBuilder.setPositiveButton(getResources().getString(R.string.strings_global____ok),
    		                new DialogInterface.OnClickListener() {
    		                    public void onClick(DialogInterface dialog, int which) {
    		    					FileReader.restoreScores(GlobalSetting.this);
    		                    }
    		                });
    		        // アラートダイアログの否定ボタンがクリックされた時に呼び出されるコールバックリスナーを登録します
    		        alertDialogBuilder.setNegativeButton(getResources().getString(R.string.strings_global____cancel),
		 ...
		 //exportBackup.setVisibility(View.GONE);
		 exportMyList.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
    		        ...
    		        alertDialogBuilder.setPositiveButton(getResources().getString(R.string.strings_global____ok),
    		                new DialogInterface.OnClickListener() {
    		                    public void onClick(DialogInterface dialog, int which) {
    		                    	FileReader.backupMyList(GlobalSetting.this);
    		                    }
    		                });
    		        // アラートダイアログの否定ボタンがクリックされた時に呼び出されるコールバックリスナーを登録します
    		        alertDialogBuilder.setNegativeButton(getResources().getString(R.string.strings_global____cancel),
		 ...
		 //importBackup.setVisibility(View.GONE);
		 importMyList.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
    		        ...
    		        alertDialogBuilder.setPositiveButton(getResources().getString(R.string.strings_global____ok),
    		                new DialogInterface.OnClickListener() {
    		                    public void onClick(DialogInterface dialog, int which) {
    		    					FileReader.restoreMyList(GlobalSetting.this);
    		                    }
    		                });
    		        // アラートダイアログの否定ボタンがクリックされた時に呼び出されるコールバックリスナーを登録します
    		        alertDialogBuilder.setNegativeButton(getResources().getString(R.string.strings_global____cancel),
		...
		((Spinner)this.findViewById(R.id.gestureOnItemLongClicked)).setOnItemSelectedListener(new OnItemSelectedListener(){
		 ...
		 showAd.setOnCheckedChangeListener(new OnCheckedChangeListener()
		{
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
				//SharedPreferences pref = getSharedPreferences("GeneralSetting", MODE_WORLD_READABLE | MODE_WORLD_WRITEABLE);
		 ...
		 //mFilterSpinner.setSelection(mSpinnerSelection);
    }
