...
//add by taiheisan end
    ...
    private boolean execUserAction(UserActionFrom from)
    {
    	...
    	switch(action)
    	{
    		case ShowItemMenu: userActionShowItemMenu(); break;
    		case OpenOwnMusic: userActionOpenOwnMusic(); break;
    		case FromGate: userActionFromGate(); break;
    		case DirectEdit: userActionDirectEdit(); break;
    		case SelectRivalAction: userActionSelectRivalAction(); break;
    		case RivalFromGate: userActionRivalFromGate(); break;
    		case RivalDirectEdit: userActionRivalDirectEdit(); break;
    		case AddToMyList: userActionAddToMyList(); break;
    		case RemoveFromMyList: userActionRemoveFromMyList(); break;
    		default: break;
    	}
    	return false;
    }
    private void userActionShowSystemMenu()
    {
	    ...
	    .setItems((String[])str_items.toArray(new String[0]), new DialogInterface.OnClickListener(){
	        public void onClick(DialogInterface dialog, int which) {
   	            switch(which)
	            {
    	            case 0: userActionOpenPreference(); break;
    	            case 1: userActionShowStatistics(); break;
    	            case 2: userActionShowStatus(); break;
    	            case 3: userActionManageRivals(); break;
    	            case 4: userActionCopyToClipboardList(); break;
    	            case 5: userActionFromGateList(); break;
    	            case 6: userActionSou(); break;
    	            case 7: userActionOmikuji(); break;
    	            case 8: userActionOpenFromGateRecent(); break;
	            }
	        }
	    }
	    ).show();
    ...
    private int getNoOfSeriesTitle(SeriesTitle ser)
    {
		switch(ser)
		{
			...
			case SuperNOVA:return 8;
			case SuperNOVA2:return 9;
			case X:return 10;
			case X2:return 11;
			case X3:return 12;
			case _2013:return 13;
			case _2014:return 14;
			case A:return 15;
			case A20:return 16;
			case A20PLUS:return 17;
			case A3:return 18;
			default:return -1;
		}
    }
    private void userActionShowStatistics()
    {
		...
		for(int i = 0; i < count; ++i)
		{
			...
			switch(score.Rank)
			{
				case AAA:++danceLevelAAA;break;
				case AAp:++danceLevelAAp;break;
				case AA:++danceLevelAA;break;
				case AAm:++danceLevelAAm;break;
				case Ap:++danceLevelAp;break;
				case A:++danceLevelA;break;
				case Am:++danceLevelAm;break;
				case Bp:++danceLevelBp;break;
				case B:++danceLevelB;break;
				case Bm:++danceLevelBm;break;
				case Cp:++danceLevelCp;break;
				case C:++danceLevelC;break;
				case Cm:++danceLevelCm;break;
				case Dp:++danceLevelDp;break;
				case D:++danceLevelD;break;
				case E:++danceLevelE;break;
				case Noplay:++danceLevelNoPlay;break;
			}
			switch(score.FullComboType)
			{
				case MerverousFullCombo:++fctypeMFC;break;
				case PerfectFullCombo:++fctypePFC;break;
				case FullCombo:++fctypeFC;break;
				case GoodFullCombo:++fctypeGFC;break;
				case Life4:++fctypeLife4;break;
				case None:++fctypeNoFC;break;
			}
    ...
    private void userActionSelectRivalAction()
    {
	    ...
	    .setItems((String[])str_items.toArray(new String[0]), new DialogInterface.OnClickListener(){
	        public void onClick(DialogInterface dialog, int which) {
	            switch(which)
	            {
    	            case 0: userActionRivalFromGate(); break;
    	            case 1: userActionRivalDirectEdit(); break;
	            }
	        }
	    }).show();
	        ...
	        public void onClick(DialogInterface dialog, int which) {
	        	if(mCategory.equals("My List"))
	        	{
	        		if(mActiveRivalId != null && mActiveRivalId != "00000000")
	        		{
			            switch(which)
			            {
			            	case 0: userActionCopyToClipboard(); break;
		    	            case 1: userActionFromGate(); break;
		    	            case 2: userActionDirectEdit(); break;
		    	            case 3: userActionSelectRivalAction(); break;
		    	            case 4: userActionAddToMyList(); break;
		    	            case 5:userActionRemoveFromMyList(); break;
		    	            case 6: userActionOpenOwnMusic(); break;
			            }
	        		}
	        		else
	        		{
			            switch(which)
			            {
		    	            ...
		    	            case 1: userActionFromGate(); break;
		    	            case 2: userActionDirectEdit(); break;
		    	            case 3: userActionAddToMyList(); break;
		    	            case 4:userActionRemoveFromMyList(); break;
		    	            case 5: userActionOpenOwnMusic(); break;
			            }
	        		}
	        	}
	        	else
	        	{
	        		...
	        		else
	        		{
			            switch(which)
			            {
		    	            ...
		    	            case 2: userActionDirectEdit(); break;
		    	            case 3: userActionAddToMyList(); break;
		    	            case 4: userActionOpenOwnMusic(); break;
			            }
	        		}
	        	}
	        }
    ...
    private void userActionOmikuji()
    {
    	...
    	switch(pat.Pattern)
    	{
    		case bSP: textColor = 0xff66ffff; level = md.Difficulty_bSP; spdp = "SINGLE"; pattern = "BEGINNER"; break;
    		case BSP: textColor = 0xffff9900; level = md.Difficulty_BSP; spdp = "SINGLE"; pattern = "BASIC"; break;
    		case DSP: textColor = 0xffff0000; level = md.Difficulty_DSP; spdp = "SINGLE"; pattern = "DIFFICULT"; break;
    		case ESP: textColor = 0xff00ff00; level = md.Difficulty_ESP; spdp = "SINGLE"; pattern = "EXPERT"; break;
    		case CSP: textColor = 0xffff00ff; level = md.Difficulty_CSP; spdp = "SINGLE"; pattern = "CHALLENGE"; break;
    		case BDP: textColor = 0xffff9900; level = md.Difficulty_BDP; spdp = "DOUBLE"; pattern = "BASIC"; break;
    		case DDP: textColor = 0xffff0000; level = md.Difficulty_DDP; spdp = "DOUBLE"; pattern = "DIFFICULT"; break;
    		case EDP: textColor = 0xff00ff00; level = md.Difficulty_EDP; spdp = "DOUBLE"; pattern = "EXPERT"; break;
    		case CDP: textColor = 0xffff00ff; level = md.Difficulty_CDP; spdp = "DOUBLE"; pattern = "CHALLENGE"; break;
    	}
