...
public class CategorySelect extends Activity {
	    ...
	    .setItems((String[])str_items.toArray(new String[0]), new DialogInterface.OnClickListener(){
	        public void onClick(DialogInterface dialog, int which) {
   	            switch(which)
	            {
    	            ...
    	            case 1: userActionShowStatus(); break;
    	            case 2: userActionManageRivals(); break;
    	            case 3: userActionDdrSa(); break;
    	            case 4: userActionFromGateList(); break;
	...
	private void initialize()
	{
        ...
        {
	        case 0: dificulties.setVisibility(View.VISIBLE); break;
	        case 1: seriesTitles.setVisibility(View.VISIBLE); break;
	        case 2: abcs.setVisibility(View.VISIBLE); break;
	        case 3: ranks.setVisibility(View.VISIBLE); break;
	        case 4: fctypes.setVisibility(View.VISIBLE); break;
	        case 5: mylists.setVisibility(View.VISIBLE); break;
	        case 6: rivals.setVisibility(View.VISIBLE); break;
	        case 7: rivals.setVisibility(View.VISIBLE);rivalwinlose.setVisibility(View.VISIBLE); break;
	        case 8: rivals.setVisibility(View.VISIBLE);rivalranks.setVisibility(View.VISIBLE); break;
	        case 9: rivals.setVisibility(View.VISIBLE);rivalfctypes.setVisibility(View.VISIBLE); break;
	        default: categoryClose(true);
        }
...
*/
   ...
   private void showDialogFromGateList()
   {
	...
	public void onResume()
	{
		...
		if(
				!new File(this.getFilesDir().getPath() + "/" + "WebMusicIds.txt").exists() ||
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*
		SharedPreferences pref = this.getSharedPreferences("PagerSetting", Context.MODE_PRIVATE);
		if(pref.getInt("PagerCount", 0) == 0)
		{
			FileReader.savePagerCount(this, 1);
			FileReader.savePagerName(this, 0, "Default");
		}
		*/
