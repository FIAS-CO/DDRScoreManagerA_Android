...
public class DDRSA extends Activity {
	...
	//private static String sSaUri = "http://skillattack.com/sa4_develop/";
	...
	private void initialize()
	{
		 ...
		 openUserPage.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
		 ...
		 authenticate.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
				    ...
				    mainView.findViewById(R.id.visiblePassword).setOnClickListener(new OnClickListener()
					{
				    ...
				    new AlertDialog.Builder(DDRSA.this)
				        ...
				        //setViewにてビューを設定します。
				        .setView(mainView)
				        .setPositiveButton(DDRSA.this.getResources().getString(R.string.strings_global____ok), new DialogInterface.OnClickListener() {
				            public void onClick(DialogInterface dialog, int whichButton) {
				    	        ...
				    	        .setCancelable(false)
				    	        .setNegativeButton(DDRSA.this.getResources().getString(R.string.strings_global____cancel), new DialogInterface.OnClickListener() {
				    	            public void onClick(DialogInterface dialog, int whichButton) {
		 ...
		 deleteAuthenticate.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
				    new AlertDialog.Builder(DDRSA.this)
			        .setIcon(android.R.drawable.ic_dialog_info)
		 ...
		 exportScores.setOnClickListener(new OnClickListener() {
				public void onClick(View view) {
